...
class ShapeExtractor:
    ...
    def extract(
        ...
        self.processing_obj = tiff_path.stem
        ...
        mesh = self._extract_mesh(binary)
    ...
    def batch_process(
        ...
        for tiff_file in tqdm(tiff_files, desc="Processing"):
            ...
            if save_binary:
                binary_output_file = (
                    binary_output_path / relative_path.with_suffix(".npy")
                )
    ...
    def _extract_mesh(self, binary):
        ...
        if not mesh.is_watertight:
            print(f"[{self.processing_obj}] Warning: Extracted mesh is not watertight.")
